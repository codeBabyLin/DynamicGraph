//package cn.DynamicGraph.kernel.impl.storageengine.impl.recordstorage;
//
////
...
//import org.neo4j.kernel.impl.storageengine.impl.recordstorage.*;
...
//
//public class TransactionRecordStateEx implements RecordState {
//    private static final TransactionRecordStateEx.CommandComparator COMMAND_COMPARATOR = new TransactionRecordStateEx.CommandComparator();
...
//        RecordProxy record1;
//        while(var3.hasNext()) {
//            record1 = (RecordProxy)var3.next();
//            commands.add(new LabelTokenCommand((LabelTokenRecord)record1.getBefore(), (LabelTokenRecord)record1.forReadingLinkage()));
//        }
//
...
//        while(var3.hasNext()) {
//            record1 = (RecordProxy)var3.next();
//            commands.add(new RelationshipTypeTokenCommand((RelationshipTypeTokenRecord)record1.getBefore(), (RelationshipTypeTokenRecord)record1.forReadingLinkage()));
//        }
//
...
//        while(var3.hasNext()) {
//            record1 = (RecordProxy)var3.next();
//            commands.add(new PropertyKeyTokenCommand((PropertyKeyTokenRecord)record1.getBefore(), (PropertyKeyTokenRecord)record1.forReadingLinkage()));
//        }
//
...
//
//            RecordProxy change;
//            NodeVersionRecord record;
//            for(Iterator var6 = this.recordChangeSet.getNodeRecords().changes().iterator(); var6.hasNext(); nodeCommands[i++] = new NodeCommand((NodeVersionRecord)change.getBefore(), record)) {
//                change = (RecordProxy)var6.next();
//                record = (NodeVersionRecord)this.prepared(change, this.nodeStore);
...
//                    return TransactionRecordStateEx.this.metaDataStore.graphPropertyRecord();
//                }
//
...
//        NodeVersionRecord nodeRecord = (NodeVersionRecord)this.recordChangeSet.getNodeRecords().getOrLoad(nodeId, (Void)null).forChangingData();
//        NodeVersionLabelsField.parseLabelsField(nodeRecord).add(labelId, this.nodeStore, this.nodeStore.getDynamicLabelStore());
//    }
//
//    void removeLabelFromNode(long labelId, long nodeId) {
//        NodeVersionRecord nodeRecord = (NodeVersionRecord)this.recordChangeSet.getNodeRecords().getOrLoad(nodeId, (Void) null).forChangingData();
//        NodeVersionLabelsField.parseLabelsField(nodeRecord).remove(labelId, this.nodeStore);
//    }
//
