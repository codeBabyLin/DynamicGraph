...
import cn.DynamicGraph.storageengine.api.txstate.TxStateVisitorEx;
import cn.DynamicGraph.storageengine.api.txstate.TxStateVisitorEx.Delegator;

public class TransactionCountingStateVisitorEx extends Delegator {
    ...
    public TransactionCountingStateVisitorEx(TxStateVisitorEx next, StorageReader storageReader, ReadableTransactionState txState, CountsRecordState counts) {
        super(next);
