...
public class GraphDatabaseFacadeFactory {
    ...
    public GraphDatabaseFacade initFacade(File storeDir, Config config, GraphDatabaseFacadeFactory.Dependencies dependencies, GraphDatabaseFacade graphDatabaseFacade) {
