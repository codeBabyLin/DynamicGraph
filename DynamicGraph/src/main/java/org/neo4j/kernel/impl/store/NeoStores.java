...
import DynamicGraph.store.DynamicNodeStore;
...
public class NeoStores implements AutoCloseable {
    ...
    CommonAbstractStore createNodeStore() {
        ...
        return this.initialize(new DynamicNodeStore(this.layout.nodeStore(), this.layout.idNodeStore(), this.config, this.idGeneratorFactory, this.pageCache, this.logProvider, (DynamicArrayStore)this.getOrCreateStore(StoreType.NODE_LABEL), this.recordFormats, this.openOptions));
