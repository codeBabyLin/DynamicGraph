...
public class DynamicNodeLabels implements NodeLabels {
    ...
    public static long[] get(NodeRecord node, NodeStore nodeStore, long version) {
        ...
        java.util.Map<Long,Long> versionLabels = new java.util.HashMap<Long, Long>();
    ...
    public static java.util.Map<Long,Long> getVersionLabels(NodeRecord node, NodeStore nodeStore) {
        //************************
        if(node.isLight()){
            nodeStore.ensureHeavyEx(node);
        }
